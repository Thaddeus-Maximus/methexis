...
%\subsection{Living to Work}
%\begin{quote}
%  ...[in] work, with no concern whether the worker grows or diminishes as a person through their own work.
%  \attrib{\textit{Centessimus Annus} 41, Pope John Paul II 1991}
%\end{quote}

%\subsection{Decommunalization}
%\begin{quote}
...
% Should this section be longer? I don't think there's really a whole lot worth diving into.
...
%  \attrib{\textit{Quadragesimo Anno} 84, Pope Pius XI, 1931}
%\end{quote}
