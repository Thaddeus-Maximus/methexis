...
Most people understand the idea of alienation at some basic level, that one should feel a connection to the fruits of their labor and a sense of pride in their work. Marx in his writings utilized the term quite frequently, but failed to grasp what it truly meant. Pope John Paul II in his encyclical \textit{Centesimus Annus} reclaims this principle from the Marxists:
...
% TODO grows / diminishes as a person
% TODO increased sharing in a genuinely supportive community
% TODO really utilize this quote because it's a trove but nothing is done with it

So what are ways in which \textit{technologies} alienate people?

Clearly, the placement of a tool between a man and his work invokes a distancing, just as clothes prevent intimacy and an in-person meeting provides more expression than a phone call. Man is \textit{sensual} and experiences the world through sensory experience.
...
It doesn't have to be this way, and surely, hedonistic patterns have existed before ours. Nowadays the temptations are so prevalent that the entering into a sacred space is for many completely jarring and difficult to comprehend. We do get tired and seek reprieve from time to time, but to sit in pure, unadulterated silence and reflection, is unbearable.
...
% TODO: gyms? not exactly here. new section maybe
...
This self-begetting interest must always be checked lest it become usury. Like a cancer, what unchecked usury does is crowd out truly productive endeavors, encumbering them and leeching off their resources.
...
Once swallowed and digested, things become clear. We recognize that our forefathers had virtue. We desire to learn their understanding, apply it to our own life, and pass it on to our children. The solution to our groanings and pains is not in the modern religions of `innovation' and `scientific thinking'. It is in the past.
...
If we want this wisdom, we must attain proper education. While some might say `holistic' education, involving a litany of courses in all subject matters is important, the reality is more severe: \textit{integrated} education is important, along with a recognition that all technologies are built from the created firmament, and ought to exist for created life to manifest virtue..
...
% TODO EXPOUND ON THIS ! SO MUCH GOOD HERE !
